...
def residual_block(bottom, num_filters, stride=1):
    if stride == 1:
        ...
        conv3 = conv_factory(pool, 1, num_filters, 1, 0)
        add = L.Eltwise(conv2, conv3, operation=P.Eltwise.SUM)
        return add
    else:
...
if __name__ == '__main__':
    tgt_file='D:/MyNet/livdet2015/resnet_22_train_test_no_padchannel.prototxt'
    make_net(tgt_file)
