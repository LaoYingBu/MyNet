...
def attention_module_1(data, res, num_filters=32):
    ...
    #    d_conv_3, data, region_height=9, region_width=9, data_height=224, data_width=224,key_scale=1.2)
...
def attention_module_2(data, res, num_filters=64):
    ...
    d_conv_1 = deconv_factory_relu(r_res_3, num_filters)

    # key_region = L.KeyPoint(
    #    d_conv_1, data, region_height=5, region_width=5, data_height=224, data_width=224,key_scale=1.2)
    key_region = d_conv_1
    sig = L.Sigmoid(key_region)
...
def make_net(tgt_file):
    with open(tgt_file, 'w') as f:
        ...
        print(resnet_cifar('dataset/cifar10_train_lmdb', 'dataset/cifar10_test_lmdb',
                           'dataset/mean.proto', n_size=2), file=f)


if __name__ == '__main__':
    tgt_file = 'D:/MyNet/livdet2015/resnet_attention_train_test_2.prototxt'
    make_net(tgt_file)
